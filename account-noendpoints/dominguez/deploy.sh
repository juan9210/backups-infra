...
ZIP_FILE="$BACKUP_DIR/dominguezlab_every-1-deploy_${date}.zip"
EVIDENCE_FILE="$BACKUP_DIR/dominguezlab_evidence.txt"

BACKUP_URL="https://dominguezlab.trial360.site/web/database/backup"
MASTER_PWD="h1Cp)/b6hjldl5x[d687"
DB_NAME="prod-dominguezlab-odoo"

S3_DEST="s3://backups-trial360/dominguezlab/deploy/"
