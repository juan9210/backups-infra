...
ZIP_FILE="$BACKUP_DIR/gemur_every-1-deploy_${date}.zip"
EVIDENCE_FILE="$BACKUP_DIR/gemur_evidence.txt"

BACKUP_URL="https://gemur.trial360.site/web/database/backup"
MASTER_PWD="h1Cp)/b6hjldl5x[d687"
DB_NAME="prod-gemur-odoo"

S3_DEST="s3://backups-trial360/gemur/deploy/"
