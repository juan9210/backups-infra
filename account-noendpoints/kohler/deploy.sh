...
ZIP_FILE="$BACKUP_DIR/kohlerandmilstein_every-1-deploy_${date}.zip"
EVIDENCE_FILE="$BACKUP_DIR/kohlerandmilstein_evidence.txt"

BACKUP_URL="https://kohlerandmilstein.trial360.site/web/database/backup"
MASTER_PWD="h1Cp)/b6hjldl5x[d687"
DB_NAME="prod-kohlerandmilstein-odoo"

S3_DEST="s3://backups-trial360/kohlerandmilstein/deploy/"
