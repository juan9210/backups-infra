...
ODOO_USER="postgres"
DB_NAME="prod-mardelplata-odoo"
BACKUP_DIR="/home/ubuntu/backups/deploy"
ZIP_FILE="mardelplata_every-1-deploy_${date}.zip"

RDS_HOST="trial360-clients-instance-1.cgpy2ks26h1e.us-east-1.rds.amazonaws.com"
FILESTORE_SRC="/opt/odoo/.local/share/Odoo/filestore/prod-mardelplata-odoo"
EVIDENCE_FILE="$BACKUP_DIR/mardelplata_evidence.txt"
S3_DEST="s3://backups-trial360/mardelplata/deploy/"
...
#######################################
# Limpieza intermedia (solo dump + filestore)
#######################################
