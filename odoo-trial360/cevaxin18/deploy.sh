...
ZIP_FILE="$BACKUP_DIR/cevaxin18-deploy_${date}.zip"
EVIDENCE_FILE="$BACKUP_DIR/cevaxin18.txt"

BACKUP_URL="https://cevaxin18.integrait.co/web/database/backup"
MASTER_PWD="h1Cp)/b6hjldl5x[d687"
DB_NAME="odoo-cevaxin18"

S3_DEST="s3://backups-cevaxin/cevaxin-18/deploy/"
