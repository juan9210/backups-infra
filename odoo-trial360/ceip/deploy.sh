...
ZIP_FILE="$BACKUP_DIR/ceip_every-1-deploy_${date}.zip"
EVIDENCE_FILE="$BACKUP_DIR/ceip_evidence.txt"

BACKUP_URL="https://ceip.trial360.site/web/database/backup"
MASTER_PWD="h1Cp)/b6hjldl5x[d687"
DB_NAME="prod-ceip-odoo"

S3_DEST="s3://backups-trial360-endpoints/ceip/deploy/"
