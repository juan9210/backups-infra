...
ZIP_FILE="$BACKUP_DIR/psn18_every-1-deploy_${date}.zip"
EVIDENCE_FILE="$BACKUP_DIR/psn18_evidence.txt"

BACKUP_URL="https://policlinicosocialdelnorte.com/web/database/backup"
MASTER_PWD="h1Cp)/b6hjldl5x[d687"
DB_NAME="prod-psn18-odoo"

S3_DEST="s3://backups-trial360-endpoints/psn18/deploy/"
